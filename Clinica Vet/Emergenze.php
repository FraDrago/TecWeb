...
<br/>
<div id="content">
    <div id="title1"><h2>Guida alle emergenze più comuni </h2></div>
...
<li><img src="img/piante.jpg" alt="icona di una pianta"><a class="piante-colore" href="#piante">Piante tossiche comuni</a></li>
	...
	<div class="name2"> <?php echo $emergenze['name']; ?> </div>
        <div class="boxImage2"><img class="image5" src="<?php echo $emergenze['Path']; ?>"
                                    alt="<?php echo htmlentities($emergenze['alt'], ENT_HTML5, "UTF-8"); ?>"></div>
    ...
    <div id="title2"><h3>Piante tossiche comuni:</h3></div>
...
<div class="box">
    ...
    <div class="boxImage"><img class="image4" src="<?php echo $piante['Path']; ?>"
                               alt="<?php echo htmlentities($piante['alt'], ENT_HTML5, "ISO8859-1"); ?>"></div>
