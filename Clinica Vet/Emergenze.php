...
<li><img src="img/piante.jpg" ><a class="piante-colore" href="#piante">Piante tossiche comuni</a></li>
	...
	I segni clinici che si possono manifestare sono: <b>iperemia delle mucose, tachicardia e respirazione affannosa</b>. Se la situazione è più grave possono subentrare: <b>incoordinazione motoria, tremori muscolari,vomito, diarrea, ipersalivazione, perdita di coscienza e crisi convulsive</b>.
	<b>Rimedi utili: bagni con acqua fresca o panni bagnati (nota bene: acqua ghiacciata o ghiaccio potrebbero aggravare la situazione).</b>
	A questo punto sarà fondamentale <u><b>portare l’animale dal veterinario</b></u> che procederà a ripristinare e sostenere il normale ritmo cardiaco, la pressione arteriosa, la diuresi e lo stato del sensorio.</div></div>
	...
	Si consiglia quindi di <b>interrompere l’alimentazione abituale</b>, di somministrare eventualmente un’ alimentazione commerciale altamente digeribile e il prima possibile di <b>raccogliere un campione di feci</b> per portarlo ad analizzare dal veterinario.</div></div>
	...
	E’ possibile <u><b>somministrare corticosteroidi a pronto utilizzo dopo aver contattato telefonicamente il veterinario</b></u>.
	...
	<b>Quando penetra nel condotto uditivo <u>non</u> bisogna cercare di rimuoverla</b>, solo il medico veterinario può intervenire.</div></div>
	...
	Se si tratta di farmaci o veleni <b>è bene indurre il vomito al più presto</b> e non somministrare latte. <u><b>Se sono trascorsi più di 20 minuti non dev’essere indotto il vomito, ma è fondamentale portare l’animale il prima possibile dal veterinario.</u></b></div></div>
