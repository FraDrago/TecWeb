...
<div>
	...
	<div class="descrizione">Il colpo di calore è un’emergenza per cani e gatti da conoscere e non sottovalutare. Questa problematica si riscontra soprattutto nei soggetti anziani e nei soggetti obesi.
	...
	I segni clinici che si possono manifestare sono: iperemia delle mucose, tachicardia e respirazione affannosa. Se la situazione è più grave possono subentrare: incoordinazione motoria, tremori muscolari,vomito, diarrea, ipersalivazione, perdita di coscienza e crisi convulsive.
	Rimedi utili: bagni con acqua fresca o panni bagnati (nota bene: acqua ghiacciata o ghiaccio potrebbero aggravare la situazione).
	...
	<div class="descrizione">Il vomito può essere un fatto episodico indotto dall’ingestione di peli, agenti irritanti, troppo cibo o bocconi troppo grossi, ma anche effetto di una patologia, in particolar modo se accompagnato da comportamenti anomali, disorientamento, disturbi dell’equilibrio. In caso di vomito è importante mantenere l’animale a digiuno e controllato per 12 o 24 ore, inducendolo però a bere poco e spesso.
	La diarrea invece può essere causata da parassiti intestinali (alcune volte riconoscibili nelle feci espulse).
	Si consiglia quindi di interrompere l’alimentazione abituale, di somministrare eventualmente un’ alimentazione commerciale altamente digeribile e il prima possibile di raccogliere un campione di feci per portarlo ad analizzare dal veterinario.</div></div>
	...
	Quando accade si deve tagliare l’unghia nel punto di rottura e successivamente lavare la parte con soluzione fisiologica, applicare poi un bendaggio. In alcuni casi potrebbe essere indispensabile somministrare un antibiotico che verrà prescritto dal medico veterinario.</div></div>
	...
	Normalmente ciò che appare a livello cutaneo è solo la punta di un iceberg, le lesioni sottostanti da strappamento sono molto frequenti. In questo caso è utile depilare la parte interessata con ampio margine, disinfettare utilizzando soluzioni diluite a base di iodio vinil pirrolidone (betadine) e lavare abbondantemente con soluzione fisiologica. L’utilizzo di terapie antibiotiche risulta quasi sempre opportuno ed è quindi consigliabile, appena possibile, rivolgersi ad un veterinario.</div></div>
	...
	<div class="descrizione">Le punture d’insetto spesso provocano reazioni allergiche che determinano un rigonfiamento dell’area che è stata colpita. Nella maggior parte dei casi la zona più interessata è quella del muso dove si verifica un ispessimento delle labbra. 
	Il sintomo più comune è lo strofinamento del muso per terra o il grattamento con le zampe.
	E’ possibile somministrare corticosteroidi a pronto utilizzo dopo aver contattato telefonicamente il veterinario.
	Se però la sintomatologia risulta grave è bene recarsi in clinica per controlli.</div>
</div>
	...
	<div class="descrizione">Le ariste delle graminacee sono diffusissime in campagna e nel periodo estivo. Questi corpi vegetali aderiscono molto facilmente al pelo del cane o del gatto, penetrando con facilità nella cute.
	...
	In entrambi i casi è possibile controllare se la spiga è visibile e in questo caso estrarla.
	...
	Quando penetra nel condotto uditivo non bisogna cercare di rimuoverla, solo il medico veterinario può intervenire.</div>
</div>
	...
	<div class="descrizione">Se si sospetta l’ingestione di una sostanza tossica sarà bene informare tempestivamente il veterinario.
