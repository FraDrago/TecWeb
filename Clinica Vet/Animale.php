<?php $pagina_attuale='Animale.php'; ?>
<!DOCTYPE  html>
...
<ul class="breadcrumb">
  ...
  <li class="bc_here">Libretto Sanitario</li>
</ul>
...
<div id="title"><h3>Ecco i tuoi animali:</h3></div>

  <p>Di chi vuoi controllare lo stato?</p>

  <!--- Lista degli animali appartenenti al proprietario presi dal database e opzione "aggiungi un nuovo animale"--->

  <a href="Libretto.php">Libretto sanitario di Pippo</a>
