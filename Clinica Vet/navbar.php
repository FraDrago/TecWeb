...
<nav role="navigation">
  <div id="menuToggle">
    ...
    <ul id="menu">
      <li <?php if($pagina_attuale=='index2.php') echo "class='active2'"; ?> ><a href='index2.php#'><span xml:lang="en" lang="en">Home</span></a></li>
          ...
          <li <?php if($pagina_attuale=='Link.php') echo "class='active2'"; ?>><a href='Link.php#'><span xml:lang="en" lang="en">Link</span> Utili</a></li>
		  ...
		  <?php
                    ...
                    if(isset($_SESSION['email'])){
						if($admin){ ?>
						<li  <?php if($pagina_attuale=='AreaPersonaleVet.php') echo "class='active2'"; ?>><a href='AreaPersonaleVet.php#'>Area Personale <span xml:lang="en" lang="en">Admin</span></a></li>
						<?php } 
						else {?>
...
<div class='nav'>
 <ul>
          <li <?php if($pagina_attuale=='index2.php') echo "class='current'"; ?> ><a href='index2.php#'><span xml:lang="en" lang="en">Home</span></a></li>
          ...
          <li <?php if($pagina_attuale=='Link.php') echo "class='current'"; ?>><a href='Link.php#'><span xml:lang="en" lang="en">Link</span> Utili</a></li>
 ...
 <?php
                    ...
                    if(isset($_SESSION['email'])){
						if($admin){ ?>
						<li <?php if($pagina_attuale=='AreaPersonaleVet.php') echo "class='current'"; ?>><a href='AreaPersonaleVet.php#'>Area Personale <span xml:lang="en" lang="en">Admin</span></a></li>
						<?php } 
						else {?>
